        ...
        <div class="container">
            <div class="container-fluid"> 
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="ul navbar-nav text-center ml-auto">
                        <li class="nav-item">
...
<div class="pengaduan mt-5">
    <div class="bg-purple"> 
        <div class="text-center">
            <h5 class="medium text-black mt-3">Report Total</h5>
            <h2 class="medium text-black">9999</h2>
        </div>
    </div>
</div>
...
<!-- footer -->
 <div class="mt-5">
    <hr>
    <div class="text-center">
        <p class="italic text-secondary">© 2024 Dzikral •All right Reserved</p>
    </div>
 </div>
